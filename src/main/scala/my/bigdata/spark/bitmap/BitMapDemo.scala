package my.bigdata.spark.bitmap
...
//    val roaringBitmap2: RoaringBitmap = new RoaringBitmap()
//    roaringBitmap2.add(1, 2, 5, 6)
//    println(roaringBitmap + "\t" + roaringBitmap2)
//    println("==========")
//    roaringBitmap.andNot(roaringBitmap2)
//    println(roaringBitmap)
//    println("============")
//    roaringBitmap2.or(roaringBitmap)
//    println(roaringBitmap2)
//    println("================")
